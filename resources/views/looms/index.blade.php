	        ...
	        <div class="editable-responsive">
	            <table class="table table-striped" id="datatable-editable">
	                ...
	                <tbody>
	                    ...
	                    <tr class="gradeX">
	                        <td>{{ $loom->name }}</td>
	                        <td>{{ $loom->branch_name }}</td>
	                        <td>{{ $loom->branch_code }}</td>
	                        <td>{{ $loom->status }}</td>
	                        <td class="actions">
	                            <a href="#" class="hidden on-editing save-row"><i class="fa fa-save" id="save-{{$loom->id}}" onclick="return saveData({{$loom->id}})"></i></a>
	                            <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
	                            <a href="#" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
	                            <a href="#" class="on-default remove-row" id="delete-{{$tehsil->id}}" onclick="return deleteData({{$loom->id}})"><i class="fa fa-trash-o"></i></a>
	                        </td>
	                    </tr>
	                   @endforeach
	                </tbody>
