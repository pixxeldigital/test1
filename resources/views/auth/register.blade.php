                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="filter_id" type="text" class="form-control" name="filter_id" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="role" id="role" class="form-control" required="required">
                                    ...
                                    <option value="pipedrive_user">Pipedrive User</option>
                                    <option value="thinklite_user">Thinklite User</option>
                                </select>
                            </div>
                        </div>
