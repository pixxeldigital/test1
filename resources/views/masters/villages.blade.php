	        ...
	        <div class="editable-responsive">
	            <table class="table table-striped" id="datatable-editable">
	                ...
	                <tbody>
	                    ...
	                    <tr class="gradeX">
	                        <td>{{ $village->name }}</td>
	                        <td>{{ $village->branch_name }}</td>
	                        <td>{{ $village->branch_code }}</td>
	                        <td>{{ $village->status }}</td>
	                        <td class="actions">
	                            <a href="#" class="hidden on-editing save-row"><i class="fa fa-save" id="save-{{$village->id}}" onclick="return saveData({{$village->id}})"></i></a>
	                            <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
	                            <a href="#" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
	                            <a href="#" class="on-default remove-row" id="delete-{{$village->id}}" onclick="return deleteData({{$village->id}})"><i class="fa fa-trash-o"></i></a>
	                        </td>
	                    </tr>
	                   @endforeach
	                </tbody>
...
function saveData(id)
{
	...
	var url = "http://192.168.0.27/loom/public/village/" +id;
	var name = $('#data_0').val();
...
/* Pull the values and write ajax here */
	var url = "http://192.168.0.27/loom/public/village";
	var name = $('#data_0').val();
	var branch_name = $('#data_1').val();
	var branch_code = $('#data_2').val();
	var status = $('#data_3').val();
